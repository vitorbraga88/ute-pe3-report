...
def _main_keyboard():
    """Botões fixados em toda mensagem: abrir app e abrir a pasta de PDFs."""
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("📋 Novo Relatório", url=PWA_URL)],
        [InlineKeyboardButton("📁 Pasta de PDFs", url=RELATORIOS_URL)],
    ])
